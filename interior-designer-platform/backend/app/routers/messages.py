...
async def create_message(
    ...
    _ = msg.sender  # ensure relationship loaded for response
    # Live update: broadcast to all connected clients
    payload = {"type": "message", "project_id": body.project_id, "payload": {"id": msg.id, "project_id": msg.project_id, "sender_id": msg.sender_id, "content": msg.content, "created_at": msg.created_at.isoformat() if msg.created_at else None, "sender": {"id": current_user.id, "name": current_user.name, "email": current_user.email, "role": current_user.role}}}
